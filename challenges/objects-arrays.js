...
// add each graduate university to universities array
graduates.forEach(graduate => {
  universities.push(graduate.university);
});

// log the universities in alphabetical order
...
// add each graduate first name and email to contactInfo array
graduates.forEach(graduate => {
...
// check if each university has "Uni" included, add the results to new array
...
// add each animal with name and scientific name to new array
...
// filters the animals with population < 5
